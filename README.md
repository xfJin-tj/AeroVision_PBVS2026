...
# Inference
Download the pretrained weights for the cross_model_2resnet, cross_model_1, and model_complete models (`cross_model_2resnet.pth` is the weight file generated by running `norm_resnet50_SAR.py`, `cross_model_1.pth` is the weight file generated by running `efficient_SAR.py`, `model_complete.pth` is the weight file generated by running `train.py`), and save them in the current directory. Ensure you update the paths in the code to point to the correct location of these weights.
